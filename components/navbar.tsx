...
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        <div className="px-4 min-h-12 rounded-full border shadow flex gap-4 items-center justify-between bg-background dark:bg-accent text-accent-foreground w-full max-w-screen-sm mx-auto ">
